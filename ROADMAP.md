...
This roadmap tracks practical improvements for keeping the storefront easier to maintain and review.

## Current Focus

- Keep the public GitHub Pages deployment and repository metadata aligned.
- Run the site quality check before publishing content or asset changes.
- Keep store information, product descriptions, and visit details reviewable through pull requests.
